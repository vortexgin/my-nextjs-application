...
export const GET = withAuthorization(handleGet, ["base:user:view:detail"]);
export const PUT = withAuthorization(handlePut, ["authorized", "base:user:view:update"]);
export const DELETE = withAuthorization(handleDelete, ["base:user:view:delete"]);
