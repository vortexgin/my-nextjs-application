...
import { ActionTable } from "@/app/base/components/action/ActionTable";
import { requireSession } from "@/libraries/Auth";

export const metadata: Metadata = {
  title: "Actions | VortexGin",
};
...
export default async function ActionListPage() {
  ...
  return (
    <AuthComponent
      ...
      allowedPermissions={["base:action:list:list"]}
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Managed through the existing actions API.
                </p>
              </div>
              <AuthComponent
                user={session.user}
              ...
              >
                <Link
                  href="/base/views/actions/create"
